...
export default function TurfAdminTurfs() {
  ...
  return (
    <div className={`p-6 transition-colors duration-200 ${
      darkMode ? 'bg-gray-900 min-h-screen' : 'bg-transparent min-h-screen'
    }`}>
      {/* Header */}
      <div className="mb-8">
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
          ...
          <div className="flex gap-3">
            { /* Refresh button - added aria-label and consistent focus */ }
            <button
              onClick={fetchTurfs}
              aria-label="Refresh turfs"
              className={`flex items-center px-4 py-2 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 ${
                darkMode
                  ? 'bg-gray-800 text-gray-300 hover:bg-gray-700 border border-gray-700'
                  : 'bg-transparent text-gray-700 hover:bg-gray-50/30 border border-gray-300'
              }`}
            >
            ...
            { /* Add New Turf - added aria-label and focus styles */ }
            <button
              onClick={handleAddTurf}
              aria-label="Add new turf"
              className="flex items-center px-6 py-2 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors duration-200 shadow-lg focus:outline-none focus:ring-2 focus:ring-green-500"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-6">
          <div className={`p-6 rounded-xl shadow-sm border ${
            darkMode ? 'bg-gray-800 border-gray-700' : 'bg-transparent border-gray-200'
          }`}>
        ...
        <div className="flex flex-col lg:flex-row gap-4 items-center justify-between">
          ...
          <div className="flex items-center gap-2">
            <button
              ...
              className={`p-2 rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-500 ${
                viewMode === "grid"
        ...
        {filteredTurfs.length === 0 ? (
          ...
          >
            ...
            {(!searchTerm && filterType === "all") && (
              <button
                onClick={handleAddTurf}
                aria-label="Add your first turf"
                className="inline-flex items-center px-6 py-3 bg-green-600 hover:bg-green-700 text-white rounded-lg transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-green-500"
              >
